...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Estrazione dei singoli identificatori numerici, ignorando le spaziature multiple.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{stringstream} per la conversione dei caratteri in numeri interi.
    \end{itemize}
