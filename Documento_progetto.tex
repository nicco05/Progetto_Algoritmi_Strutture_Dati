...
\begin{enumerate}
    ...
    \begin{itemize}
       \item \textbf{Tabelle Hash con Hashing Universale:} per la memorizzazione dei nodi verrà utilizzata una tabella hash con funzione di hash universale:
        ...
        \item \textbf{Liste di adiacenza pesate:} la tabella hash mapperà l'ID del nodo sorgente a un contenitore (vettore o lista) di archi uscenti, in cui ogni elemento memorizzerà l'ID del nodo destinazione e la relativa frequenza aggiornata.
    \end{itemize}
